...
| `collective-open-two-coops` | convite aberto | Sim, desde S1-02 | S3-01/S3-02 portam APIs/UI |
| `collective-contribution-pending` | contribuicao pendente | Sim, desde S1-02 | S3-02 porta reserva por contribuicao |
