...
const LEVEL_DEFINITIONS = [
  ...
  { levelNumber: 4, levelName: 'Coletor', xpRequired: 464 },
  { levelNumber: 5, levelName: 'Profissional', xpRequired: 774 },
  { levelNumber: 6, levelName: 'Especialista', xpRequired: 1291 },
  { levelNumber: 7, levelName: 'Mestre', xpRequired: 2154 },
  { levelNumber: 8, levelName: 'Elite', xpRequired: 3593 },
  { levelNumber: 9, levelName: 'Campeão', xpRequired: 5992 },
...
const ACHIEVEMENT_DEFINITIONS = [
  {
    ...
    achievementName: 'Iniciante',
    description: 'Coletar 50 kg de materiais em um mês',
    category: 'WEIGHT',
  ...
  },
  {
    ...
    achievementName: 'Amador',
    description: 'Coletar 100 kg of materiais em um mês',
    category: 'WEIGHT',
  ...
  },
  {
    ...
    achievementName: 'Profissional',
    description: 'Coletar 250 kg de materiais em um mês',
    category: 'WEIGHT',
  ...
  },
  {
    ...
    achievementName: 'Mestre Coletor',
    description: 'Coletar 500 kg de materiais em um mês',
    category: 'WEIGHT',
  ...
  },
  {
    ...
    achievementName: 'Coletor Lendário',
    description: 'Coletar 1000 kg de materiais em um mês',
    category: 'WEIGHT',
  ...
  },
  {
    ...
    achievementName: 'Primeiros Passos',
    description: 'Trabalhar pelo menos 5 dias em um mês',
  ...
  },
  {
    ...
    achievementName: 'Em Ritmo Firme',
    description: 'Trabalhar pelo menos 10 dias em um mês',
    category: 'DAYS_WORKED',
  ...
  },
  {
    ...
    achievementName: 'Trabalhador Comprometido',
    description: 'Trabalhar pelo menos 15 dias em um mês',
    category: 'DAYS_WORKED',
  ...
  },
  {
    ...
    achievementName: 'Trabalhador Dedicado',
    description: 'Trabalhar pelo menos 20 dias em um mês',
    category: 'DAYS_WORKED',
  ...
  },
  {
    ...
    achievementName: 'Trabalhador Imparável',
    description: 'Trabalhar pelo menos 25 dias em um mês',
    category: 'DAYS_WORKED',
  ...
  },
  {
    ...
    achievementName: 'Estrela Ascendente',
    description: 'Desbloquear 3 conquistas diferentes em um mês',
  ...
  },
  {
    ...
    achievementName: 'Estrela Brilhante',
    description: 'Desbloquear 5 conquistas diferentes em um mês',
    category: 'ACHIEVEMENTS_COUNT',
    thresholdValue: '5.00',
    baseXpReward: 300,
    difficulty: 'HARD',
  },
  {
    ...
    achievementName: 'Superestrela',
    description: 'Desbloquear 8 conquistas diferentes em um mês',
    category: 'ACHIEVEMENTS_COUNT',
    thresholdValue: '8.00',
    baseXpReward: 500,
    difficulty: 'HARD',
  },
  {
    ...
    achievementName: 'Superestrela Lendária',
    description: 'Desbloquear 10 conquistas diferentes em um mês',
    category: 'ACHIEVEMENTS_COUNT',
    thresholdValue: '10.00',
    baseXpReward: 750,
    difficulty: 'HARD',
