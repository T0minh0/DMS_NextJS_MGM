...
export const UAT_SALE_LIFECYCLE_FIXTURES: Array<{
...
}> = [
  {
    ...
    notes: 'Venda normal com sold_at/cancelled_at nulos; nao movimenta estoque ate S2-01 portar complete.',
  },
  {
    ...
    state: 'completed',
    seededInCurrentSchema: true,
    notes: 'Venda normal com sold_at preenchido e estoque ja consolidado pelo comportamento legado.',
  },
  {
    ...
    state: 'cancelled',
    seededInCurrentSchema: true,
    notes: 'Venda normal com cancelled_at preenchido e sem movimento de estoque.',
  },
  {
...
export const UAT_JOURNEY_FIXTURE_MATRIX: Array<{
  ...
  },
  {
    ...
    gap: 'S1-01 persiste lifecycle no schema; S2-01 ainda deve portar endpoints complete/cancel e ajustar a UI.',
